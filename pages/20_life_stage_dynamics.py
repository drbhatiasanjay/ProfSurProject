"""
Life Stage Dynamics — Stage Transition Analysis.

Answers: How and why do firms move between life stages? What triggers those moves?
How do macro events reshape transition patterns?

Tab 0: Transition Probability Matrix + Stage Metrics Matrix
Tab 1: Event Impact Matrices (Leverage, Transition Rate, Deterioration)
Tab 2: Stage Pathway Discovery
Tab 3: Post-COVID Cohort Analysis
...
db.log_page_visit("Life Stage Dynamics")
st.markdown("### Life Stage Dynamics")
st.caption("How firms move between stages, what triggers transitions, and how events reshape patterns")
...
# ══════════════════════════════════════════════
# TAB 0: Transition Probability Matrix + Metrics
# ══════════════════════════════════════════════
with tab_markov:

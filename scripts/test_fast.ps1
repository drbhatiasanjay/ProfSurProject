...
& $python -m py_compile models\agent_tools.py models\llm_adapters.py models\ml_predict.py models\stata_engine.py pages\19_ai_assistant.py pages\23_stata_studio.py
